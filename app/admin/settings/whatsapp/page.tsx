...
function BotMonitor({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/60 backdrop-blur-sm p-4">
      <div className="bg-card w-full h-[600px] max-h-[90vh] max-w-3xl border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
        ...
        <div className="px-6 py-4 border-b border-border flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="h-9 px-3 rounded-xl border border-border text-xs font-medium text-muted-foreground hover:bg-muted transition-all flex items-center gap-2"
            >
