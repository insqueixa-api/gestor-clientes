    ...
    <div className="space-y-6 pt-0 pb-6 px-0 sm:px-6 min-h-screen bg-slate-50 dark:bg-[#0f141a] transition-colors" id="dashboard-values">
      ...
      {showModalAdd && (
        <Modal title="Adicionar Lançamento" onClose={() => setShowModalAdd(false)}>
          <div className="p-4 text-center text-slate-500 h-32 flex items-center justify-center border-2 border-dashed border-slate-200 rounded-xl">
             Em breve: Formulário completo de Receitas, Despesas e Recorrências.
          </div>
          <div className="flex justify-end gap-2 mt-4 pt-4 border-t border-slate-200 dark:border-white/10">
            ...
            <button className="px-6 py-2 rounded-lg bg-emerald-600 text-white text-sm font-bold shadow-lg shadow-emerald-900/20">Salvar</button>
          </div>
        </Modal>
      )}
