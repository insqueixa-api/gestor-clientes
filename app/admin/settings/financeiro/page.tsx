...
function ActionBtn({
  ...
  const colors = {
    ...
    green: "text-emerald-500 bg-emerald-500/10 border-emerald-500/20 hover:bg-emerald-500/20 dark:border-emerald-500/20 dark:hover:bg-emerald-500/20",
    amber: "text-amber-500 bg-amber-500/10 border-amber-500/20 hover:bg-amber-500/20 dark:border-amber-500/20 dark:hover:bg-amber-500/20",
          ...
          <div>
            <div className="grid grid-cols-7 gap-1 mb-1">
              {["D", "S", "T", "Q", "Q", "S", "S"].map((d, i) => (
                <div key={i} className="text-center text-[10px] font-medium text-muted-foreground/80 py-1">
                  {d}
                </div>
              ))}
            </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
            <button
              ...
              className="flex h-10 px-4 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-sm shadow-lg shadow-emerald-900/20 items-center gap-2 transition-all"
            >
