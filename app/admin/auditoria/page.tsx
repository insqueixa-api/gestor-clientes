...
function AuditoriaPageContent() {
  ...
  function getFulfillmentBadge(status: string, paymentStatus: string) {
    ...
    if (status === "manual_pending")
      return (
        <span className="gap-1 px-2 py-1 rounded-lg shadow-sm tracking-tight bg-purple-500/10 text-purple-400 text-[10px] font-medium uppercase border border-purple-500/30 animate-pulse">
          Ação Manual
        </span>
      );
    if (status === "error")
                            ...
                            {isManualPending && (
                              <>
                                ...
                                <button
                                  ...
                                  className="gap-1 px-3 py-1.5 bg--500/15 dark:bg--500/20 hover:bg-rose-500/10 text-rose-400  dark:hover:bg--500/15 dark:bg--500/20 dark:text-rose-400 text-[10px] font-medium uppercase rounded-lg transition-colors border border-rose-500/20 shadow-sm flex items-center justify-center gap-1"
