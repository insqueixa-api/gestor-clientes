...
export default function PlanosPage() {
  ...
  // ✅ NOVO: controle de expand/minimize por tabela (default: minimizada)
            ...
            return (
              ...
              >
                ...
                <div className="px-5 py-3 flex justify-between items-center border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5">
                  ...
                  <div className="flex items-center gap-2">
                    {/* ✅ NOVO: expand/minimize (somente consulta, sem editar) */}
                    <button
                ...
                {/* ✅ NOVO: começa minimizado. Ao expandir, mostra a matriz completa (somente leitura). */}
                {isExpanded && (
