...
// 🔒 TRAVA: Só dispara se whatsappOptIn for true
if (sendPaymentMsg && whatsappOptIn && messageContent && messageContent.trim()) {
                  ...
                  {selectedApps.map((app) => {
                    ...
                    if (dateField) {
                        ...
                        if (expireDateIso) {
                            ...
                            const expDate = new Date(`${expireDateIso}T12:00:00`); expDate.setHours(0,0,0,0);
                          ...
                          >
                             ...
                             {/* ✅ NOVO: Tag Vencendo/Vencido */}
                               {isExpiringSoon && diffDays !== null && (
                                 <span title={diffDays < 0 ? "Vencido no Painel" : `Vence em ${diffDays} dias`} className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-rose-100 dark:bg-rose-500/15 border border-rose-200 dark:border-rose-500/30 text-rose-600 dark:text-rose-400 animate-pulse shadow-sm ml-1">
