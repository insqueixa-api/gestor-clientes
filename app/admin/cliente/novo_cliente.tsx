...
// ✅ Se ainda vazio (ex: Elite), gera silenciosamente a partir dos domínios do servidor
const autoGeneratedM3u = (!m3uUrl.trim() && !apiM3uUrl) ? buildM3uUrlSilent() : "";
const finalM3u = (apiM3uUrl || m3uUrl || autoGeneratedM3u || "").trim();
...
function buildM3uUrlSilent(): string {
  if (!username.trim() || serverDomains.length === 0) return "";
