...
> = {
  sky: {
    bar: "linear-gradient(to right,#0284c7,#0ea5e9)",
    barBg: "bg-sky-500/20",
    rank: "text-sky-400",
    ...
    value: "text-sky-400",
    topBar: "linear-gradient(to right,#0369a1,#0ea5e9,#38bdf8)",
  },
  emerald: {
    bar: "linear-gradient(to right,#059669,#10b981)",
    ...
    topBar: "linear-gradient(to right,#065f46,#059669,#34d399)",
  },
  violet: {
    bar: "linear-gradient(to right,#7c3aed,#8b5cf6)",
    ...
    topBar: "linear-gradient(to right,#4c1d95,#7c3aed,#a78bfa)",
  },
  rose: {
    bar: "linear-gradient(to right,#e11d48,#f43f5e)",
    ...
    label: "text-foreground/90",
    value: "text-rose-400",
    topBar: "linear-gradient(to right,#881337,#e11d48,#fb7185)",
  },
  amber: {
    bar: "linear-gradient(to right,#d97706,#f59e0b)",
