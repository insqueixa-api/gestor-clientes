...
> = {
  sky: {
    bar: "linear-gradient(to right,rgba(14,165,233,0.15),rgba(14,165,233,0.4))",
    barBg: "bg-sky-500/20",
    rank: "text-sky-400",
  ...
  emerald: {
    bar: "linear-gradient(to right,rgba(16,185,129,0.15),rgba(16,185,129,0.4))",
  ...
  violet: {
    bar: "linear-gradient(to right,rgba(139,92,246,0.15),rgba(139,92,246,0.4))",
  ...
  rose: {
    bar: "linear-gradient(to right,rgba(244,63,94,0.15),rgba(244,63,94,0.4))",
  ...
  amber: {
    bar: "linear-gradient(to right,rgba(245,158,11,0.15),rgba(245,158,11,0.4))",
