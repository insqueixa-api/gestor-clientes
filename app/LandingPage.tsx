    ...
    <div className="bg-[#0b1015] text-white min-h-screen overflow-x-hidden font-sans">
      ...
      <header className="fixed top-0 w-full z-50 bg-black/40 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8 text-sm text-zinc-400 font-semibold">
            <a href="#dashboard" className="hover:text-white transition">Financeiro</a>
          ...
          <a
            href="https://unigestor.net.br/login"
            className="h-11 px-6 bg-emerald-600 hover:bg-emerald-500 rounded-xl font-bold flex items-center transition-all hover:scale-105 active:scale-95 shadow-lg shadow-emerald-500/20"
          >
            Acessar sistema
          </a>
        </div>
      ...
      <section className="pt-32 pb-24">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <a
              href="https://unigestor.net.br/login"
              className="inline-flex mt-10 h-14 px-10 bg-emerald-600 hover:bg-emerald-500 rounded-xl font-bold items-center transition-all hover:scale-105 active:scale-95 shadow-xl shadow-emerald-500/20"
            >
              Começar agora
            </a>
          </div>
            ...
            <div className="rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 p-6 shadow-2xl">
              ...
              <div className="mt-8 h-32 flex items-end gap-2">
                {[20, 40, 30, 60, 80, 50, 90].map((h, i) => (
                  <div
                    key={i}
                    className="flex-1 bg-emerald-500/40 rounded-t-md hover:bg-emerald-400 transition"
                    style={{ height: `${h}%` }}
                  />
                ))}
              </div>
              ...
              <div className="mt-8 space-y-4 text-sm">
                {[
                  ...
                  <div key={name} className="flex justify-between">
                    ...
                    <span className={value.includes("+") ? "text-emerald-400 font-bold" : "text-rose-400 font-bold"}>
                      {value}
                    </span>
                  </div>
                ))}
      ...
      <section className="py-24 text-center">
        ...
        <p className="text-zinc-400 mt-6 max-w-2xl mx-auto">
          ...
          no final do mês sobra a mesma dúvida:
        </p>
      ...
      <section className="py-20 max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-6">
        {[
          ...
          <div key={title} className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:border-emerald-500/40 transition">
      ...
      <section id="modulos" className="py-24 text-center">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 px-6">
          {[
            ...
            <div key={title} className="bg-white/5 border border-white/10 p-8 rounded-3xl hover:scale-[1.02] transition">
      ...
      <section className="py-24 text-center">
        ...
        <a
          href="https://unigestor.net.br/login"
          className="inline-flex mt-10 h-14 px-12 bg-emerald-600 hover:bg-emerald-500 rounded-xl font-bold items-center transition-all hover:scale-105 active:scale-95 shadow-xl shadow-emerald-500/20"
        >
          Entrar no UniGestor
        </a>
      </section>
      ...
      <a
        ...
        target="_blank"
        className="fixed bottom-6 right-6 bg-green-500 hover:bg-green-400 w-14 h-14 rounded-full flex items-center justify-center shadow-2xl text-xl"
      >
        💬
      </a>
