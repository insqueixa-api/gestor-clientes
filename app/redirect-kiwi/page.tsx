  ...
  return (
    <div style={{ textAlign: "center", marginTop: "100px", fontFamily: "sans-serif" }}>
      ...
      <p id="fallback-msg" style={{ display: "none", color: "#666" }}>
        Se o Kiwi Browser não abriu automaticamente, certifique-se de que ele está instalado.
        <br /><br />
        <a href={`intent://${url?.replace(/^https?:\/\//, "")}#Intent;scheme=https;package=com.kiwibrowser.browser;action=android.intent.action.VIEW;end;`} style={{ color: "#10b981" }}>
          Tentar novamente
        </a>
      </p>
    </div>
