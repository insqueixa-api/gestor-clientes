...
// ✅ 12/09/2026: 60s → 120s. Fluid Compute foi mantido ligado de vez — sem
// mais teto de 60s do Hobby. renewDuplecastWithCode teve seu próprio timeout
// de fetch na VM ampliado de 55s pra 100s (mais folga real pro retry do
// Cloudflare do lado deles, ver lib/apps/duplecast-renewal.ts) — 120s aqui
// cobre isso com margem pro resto da rota (auth cacheada + loadClientApp +
// updates simples no Supabase).
