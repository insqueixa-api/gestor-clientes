// app/api/integrations/natv/sync/route.ts
...
const tenant_id = String(body?.tenant_id ?? "").trim();
  ...
  const { data: integ, error: integErr } = await supabase
    ...
    console.error("[integration_error:natv:sync]", { message: (e as any)?.message, kind: "integration_error", provider: "natv", action: "sync" });
